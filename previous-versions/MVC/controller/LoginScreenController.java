...
public class LoginScreenController {
    ...
    public void goToMainScreen(ActionEvent actionEvent) throws IOException {
        ...
        scene = FXMLLoader.load(getClass().getResource("/previous-versions/MVC/view/weekView.fxml"));
    ...
    private static void alert(String alertType, String alertTitle, String message) {
        if(Locale.getDefault().getLanguage().equals("fr")) {
            ResourceBundle fr = JavaFxApplications.resources("previous-versions/resources/bundles/app_fr");
