...
//            LOGGER.info("Exception thrown " + e.getMessage());
    ...
    public Optional<User> getByNameAndPassword(String name, String password) throws Exception {

        ResultSet resultSet = null;

        try (var connection = getConnection();
             var statement = connection.prepareStatement("SELECT * FROM user WHERE userName = ? AND password = ?")) {
